...
if __name__ == '__main__':
    ...
    exp_name = f'network={cfg.network}_d-hidden={cfg.d_hidden}_n-layers={cfg.n_layers}_weighted_loss={cfg.weighted_loss}_n-freqs={cfg.n_freqs}_sample_strg={cfg.resample}'
    if cfg.exp_tag != '':
